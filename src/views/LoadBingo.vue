...
export default {
  ...
  methods: {
    loadToken () {
      ...
      console.log(decoded)
      try {
        this.$store.commit('changeFNum', { num: decoded.firstNumber })
        this.$store.commit('changeLNum', { num: decoded.lastNumber })
        this.$store.commit('changeAList', { AList: decoded.alreadyList })
